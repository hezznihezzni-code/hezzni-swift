...
struct CarRentalScreen: View{
    ...
    @State private var showVehicleInformationScreen = false
    
    var body: some View{
        NavigationStack{
            if showVehicleInformationScreen {
                VehicleInformationScreen(
                    onBack: {
                        withAnimation{
                            showVehicleInformationScreen = false
                        }
                    }
                )
                ...
                VStack{
                    CustomAppBar(title: "Car Rental", weight: .medium, backButtonAction: {
                        onBack?()
                    })
                            ...
                            ForEach(mockVehicles, id: \.id) { vehicle in
                                vehicleCard(vehicle)
                                    .onTapGesture {
                                        ...
                                        withAnimation{
                                            showVehicleInformationScreen = true
                                        }
                                    }
                            }
                        }
...
//                        VehicleInformationScreen(/*vehicle: vehicle*/)
//                    }
//                }
            }
        }
...
struct CarInformationScreen: View {
    var body: some View{
