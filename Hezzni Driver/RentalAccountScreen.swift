//
//  RentalAccountScreen.swift
//  Hezzni
//
//  Created by Zohaib Ahmed on 1/1/26.
//

import SwiftUI

// Copy of AccountRoute for driver
enum RentalAccountRoute: Hashable {
    case login
...
struct RentalAccountScreen: View {
    @State private var currentRoute: RentalAccountRoute? = nil
